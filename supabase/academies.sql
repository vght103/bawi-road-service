...
INSERT INTO academies (id, name, region, style, "desc", price, rating, tags, image, courses, dormitories) VALUES
(
  '1', 'SMEAG Capital', '세부', '스파르타',
  '세부 최대 규모 어학원. IELTS, TOEIC 공인시험 센터를 보유하고 있어 시험 준비에 최적화된 환경.',
  '$1,350', '4.5', ARRAY['ESL', 'IELTS', 'TOEIC'],
...
(
  ...
  '$1,400', '4.6', ARRAY['ESL', 'IELTS', '비즈니스'],
...
(
  ...
  '$1,420', '4.5', ARRAY['ESL', 'TOEFL', 'TOEIC'],
